...
ovs-vsctl set Interface dpdk-1 options:"n_rxq=1" other_config:pmd-rxq-affinity="0:4"

ovs-vsctl set Interface vhost-user-0-n0 options:"n_rxq=1" other_config:pmd-rxq-affinity="0:50"
ovs-vsctl set Interface vhost-user-1-n0 options:"n_rxq=1" other_config:pmd-rxq-affinity="0:52"
